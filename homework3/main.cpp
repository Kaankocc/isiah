...
int main()
{
  try
  {
    ...
    ///
    GroceryStore store( "GroceryStoreInventory.dat" );
    /////////////////////// END-TO-DO (1) ////////////////////////////
    ...
    ///
    auto shoppingCarts = store.makeShoppingCarts();
    ...
    auto               itemsSold = store.ringUpCustomers( shoppingCarts, receipt );

    std::cout << "Receipts:\n\n"
              << receipt.str() << std::endl;
    /////////////////////// END-TO-DO (3) ////////////////////////////
    ...
    std::cout << "Frozen Spanish Omelets removed from inventory.\n";
    ...
    std::ostringstream reorderReport;
    store.reorderItems( itemsSold, reorderReport );

    std::cout << "Re-ordering grocery items the store is running low on.\n"
              << std::endl;
    std::cout << reorderReport.str() << std::endl;
